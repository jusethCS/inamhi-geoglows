...
export class dataApp{
  ...
  public forecastData = [
    {Model: "WRF", Variable: "Precipitación",       Temporal: "3 Horaria",  Code: "wrf-precipitation", Tag: "(mm)"},
    {Model: "WRF", Variable: "Precipitación",       Temporal: "Diaria",     Code: "wrf-precipitation", Tag: "(mm)"},
    {Model: "WRF", Variable: "Precipitación",       Temporal: "Semanal",     Code: "wrf-precipitation", Tag: "(mm)"},
    {Model: "WRF", Variable: "Temperatura",         Temporal: "3 Horaria",  Code: "wrf-temperature", Tag: "(°C)"},
    {Model: "WRF", Variable: "Temperatura",         Temporal: "Diaria",     Code: "wrf-temperature", Tag: "(°C)"},
    {Model: "WRF", Variable: "Humedad relativa",    Temporal: "3 Horaria",  Code: "wrf-humidity", Tag: "(%)"},
    {Model: "WRF", Variable: "Humedad relativa",    Temporal: "Diaria",     Code: "wrf-humidity", Tag: "(%)"},
    {Model: "WRF", Variable: "Velocidad del viento",Temporal: "3 Horaria",  Code: "wrf-windspeed", Tag: "(m/s)"},
    {Model: "WRF", Variable: "Velocidad del viento",Temporal: "Diaria",     Code: "wrf-windspeed", Tag: "(m/s)"}
  ]
