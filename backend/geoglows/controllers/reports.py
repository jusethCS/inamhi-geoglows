...
def report(table):
    ...
    elementos = [
        ...
        Spacer(1, 3),
        Image("/var/www/html/assets/reports/hydropowers-forecast-daily.png", width=10*cm, height=10*cm),
        Image("/var/www/html/assets/reports/colorbar-pacum.png", width=10 * cm, height=0.7 * cm),
        Spacer(1, 10),
