...
def report(filename, pacum, pacum_table, paute_table, cuenca_table, gualaceo_table, mazar_table, juval_table, palmira_table):
    ...
    elementos = [
        ...
        PageBreak(),
        ##
        Paragraph("<b>Pronóstico corregido de caudales</b>", estilo_subtitulo),
        Spacer(1, 16),
...
try:
    ...
    shutil.copy("paute.png", "/var/www/html/hydrometeorological-charts/paute.png")
    shutil.copy("cuenca.png", "/var/www/html/hydrometeorological-charts/cuenca.png")
    shutil.copy("gualaceo.png", "/var/www/html/hydrometeorological-charts/gualaceo.png")
    #
    # Generate report
