...
def download_imerg(date_start, date_end, frequency):
    # Configure log file
    log_file = f'imerg-early-{frequency}.log'
    ...
    for i in range(len(dates)):
        ...
        try:
            if(frequency == "annual"):
                ...
                for i in range(len(dd_range)):
                    ...
                    url = f"{endpoint}/imerg-early-monthly/{dd}/{dd}.geotiff"
                    #
        ...
        try:
            geo.create_coveragestore(
                ...
                path=outpath, 
                workspace=f'imerg-early-{frequency}')
        except:
        ...
        geo.publish_style(
            layer_name=layer_name, 
            style_name=f'precipitation_style_imerg_early_{frequency}', 
            workspace=f'imerg-early-{frequency}')
